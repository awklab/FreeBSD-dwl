...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xf8f8f2ff, 0x282a36ff, 0x44475aff },
	[SchemeSel] =  { 0xf8f8f2ff, 0x754eb5ff, 0x754eb5ff },
    [SchemeUrg]  = { 0xf8f8f2ff, 0xff5555ff, 0xff5555ff },
...
static const char *menucmd[] = { "wmenu-run", "-f", "Monospace 9", "-N", "#282a36", "-n", "#f8f8f2", "-S", "#754eb5", "-s", "#f8f8f2", NULL };
static const char *browsercmd[] = { "firefox", NULL, "Firefox"};
static const char *mutecmd[]   = { "mixer", "vol.mute=toggle", NULL };
static const char *voldowncmd[] = { "mixer", "vol=-.05", NULL };
static const char *volupcmd[]   = { "mixer", "vol=+.05", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_Left,	      tagtoadjacent,    {.i = -1} },
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_Right,	      tagtoadjacent,    {.i = +1} },
